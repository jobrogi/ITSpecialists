    ...
    <div className="w-full h-full pt-52">
      <div className="flex flex-wrap w-full h-full justify-center items-center pb-48 ">
        <div className=" text-8xl text-white font-monts text-center pt-20  transition-all pointer-events-none">
          ...
          <p className="text-2xl text-center pt-8 text-gray-600">
            Your on-demand Personal assistant to everything.
          </p>
        </div>
        <div className="w-full pb-20 self-start">
          <ul className="flex w-full h-fit justify-center gap-20">
            <li title="Click for a list of all our services!">
              <button className="w-52 h-12 p-2 flex justify-center items-center bg-white text-black font-roboto font-semibold rounded-lg text-2xl hover:text-3xl transition-all">
                Our Services
              </button>
            </li>
            <li title="Click for a list of ways to contact us!">
              <button className="w-52 h-12 p-2 border-white border-2 text-white flex justify-center items-center font-roboto font-semibold rounded-lg text-2xl hover:text-3xl transition-all">
                Contact Us
              </button>
            </li>
          </ul>
